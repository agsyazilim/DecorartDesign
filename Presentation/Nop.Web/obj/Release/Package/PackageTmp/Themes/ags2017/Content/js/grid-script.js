$(document).ready(function() {
	$('#grid_to4').click(function() {
		$('.grid-options .dropdown-toggle span.glyphicon').removeClass('glyphicon-th-large').removeClass('glyphicon-th-list').addClass('glyphicon-th');
		...
		$('.grid-4 .urun-list__urun').removeClass('col-sm-4')
			.addClass('col-sm-3').css('height', 400);
	...
	$('#grid_to3').click(function() {
		$('.grid-options .dropdown-toggle span.glyphicon').removeClass('glyphicon-th').removeClass('glyphicon-th-list').addClass('glyphicon-th-large');
		...
		$('.grid-3 .urun-list__urun').removeClass('col-sm-3')
			.addClass('col-sm-4').css('height', 400);
		$('.grid .urun-list__urun .urun-liste-resim').removeClass('col-sm-4');
		$('.grid .urun-list__urun .urun-list__urun-yazi').removeClass('col-sm-8');
		$('.grid .urun-list__urun .urun-border').removeClass('col-xs-12');
	});
	...
	$('#grid_tolist').click(function() {
		$('.grid-options .dropdown-toggle span.glyphicon').removeClass('glyphicon-th-large').removeClass('glyphicon-th').addClass('glyphicon-th-list');
		...
		$('.grid-list .urun-list__urun').removeClass('col-sm-3').removeClass('col-sm-4')
			.addClass('col-sm-12').css('height', 225);
