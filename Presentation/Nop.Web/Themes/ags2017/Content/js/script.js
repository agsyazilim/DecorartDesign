...
if (!isMobile()) {
  ...
  $(window).bind('scroll', function () {
    if ($(window).scrollTop() > 700) {
      ...
      $('.header__logo__image_big').removeClass('hidden-xs').addClass('visible-xs');
      $('.header__logo__image_mini').removeClass('visible-xs').addClass('hidden-xs');
      ...
      $('.header__logo__image_mini').removeClass('hidden-xs').addClass('visible-xs');
      $('.header__logo__image_big').removeClass('visible-xs').addClass('hidden-xs');
      $('.dropdown__container')
